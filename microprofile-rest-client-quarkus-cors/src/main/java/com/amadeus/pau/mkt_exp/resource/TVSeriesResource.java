...
public class TVSeriesResource {
    ...
    //http://localhost:8080/microprofile-rest-Client-quarkus-cors/tvseries/1
    @GET
    @Path("/{id}")
    ...
    //http://localhost:8080/microprofile-rest-Client-quarkus-cors/tvseries/person?q=lauren
    @GET
